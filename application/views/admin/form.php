				...
				<div class="panel-title">
					<?php
						switch ($act) {
							...
							default:
								echo 'Perbaharui Data Administrator';
								break;
						}
					?>
				</div>
			...
			<div class="panel-body">
				...
				<form role="form" class="form-horizontal form-groups-bordered" method="post" action="<?php echo $action; ?>">
					...
					<div class="form-group">
						<label for="nama" class="col-sm-3 control-label">Nama Administrator</label>
						
						<div class="col-sm-5">
							<input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Administrator" value="<?php echo isset($nama) ? $nama : ''; ?>" required>
						</div>
					</div>
