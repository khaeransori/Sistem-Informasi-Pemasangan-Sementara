...
<head>
	...
	<title>SIMON PENSEM | Login</title>
...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content">
			...
			<p class="description">Silakan anda melakukan login terlebih dahulu!</p>
		...
		<div class="login-content">
			<?php
				if ($this->session->flashdata('message') == 'true') {
					echo '<div class="alert alert-danger"><strong>Oh snap!</strong> Username atau Password anda salah, sila coba lagi.</div>';
				}
			?>
			
			<form action="<?php echo base_url(); ?>" method="post" role="form" id="form_login">
